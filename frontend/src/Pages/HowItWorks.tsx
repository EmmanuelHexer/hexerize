  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row px-10 py-10 md:py-15 justify-between items-center p-4">
        ...
        <button className="px-6  text-white bg-[color:var(--accent-color)] hover:brightness-110 rounded-full shadow-xl ring-2 ring-[color:var(--accent-color)]/30 hover:ring-[color:var(--accent-color)]/50 transition-all transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-[color:var(--accent-color)]/40 animate-slide-up overflow-hidden  py-4 duration-400 cursor-pointer hover:bg-green-100  font-semibold">
          Discover More
        </button>
      </div>
